...
Route::middleware(['auth','admin'])->prefix('admin')->namespace('Admin')->group(function () {
    ...
    Route::delete('/products/{id}/save', 'ProductController@destroy'); //formulario eliminar
    ...
    Route::delete('/categories/{category}/save', 'CategoryController@destroy'); //formulario eliminar
