...
@section('content')
    ...
    <div class="header header-filter" style="background-image: url('{{asset('img/530206.jpg')}}'); background-size: cover; background-position: top center;">
        <div class="container">
            <div class="row">
                        ...
                        <form class="form" method="POST" action="{{ route('register') }}">
                            ...
                            <div class="content">
                                ...
                                <div class="input-group">
                                    ...
                                    "name" value="{{ old('name') }}" required autofocus>
                                </div>
