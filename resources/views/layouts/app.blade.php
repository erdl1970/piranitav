...
<head>
    ...
    <title>@yield('title', 'Pirañita Acuario')</title>
    ...
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <table class="text-right">
                       ...
                       <td><<a class="navbar-brand" href="{{url('/')}}"><h4> Home</h4></a></td>


                <td><a class="navbar-brand" href="{{url('/')}}">
                        <img class="tamaño" src="{{'/img/logopirana.png'}}"></a></td>
