        ...
        <div class="profile-content">
            <div class="container">
                <div class="row">
                    <div class="profile">
                        <div class="avatar">
                            <img src="/img/search.jpg" alt = "Imagen de una lupa que representa a la
                            página de resultados" class="img-circle img-responsive img-raised">
                        </div>
                ...
                <div class="description text-center">
                    <p>Se encontraron <?php echo e($products->count()); ?> resultados para el término
                    <span class="label label-info" style="text-transform:lowercase">  <?php echo e($query); ?></span></p>
                </div>
